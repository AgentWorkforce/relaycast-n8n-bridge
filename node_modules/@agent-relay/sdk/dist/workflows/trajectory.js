...
function classifyFailure(error) {
    ...
    if (e.includes('failed to spawn') || e.includes('enoent'))
        return 'spawn_failed';
    if (e.includes('exit code') || e.includes('exited with'))
        return 'exit_nonzero';
    if (e.includes('aborted') || e.includes('cancelled'))
        return 'aborted';
    return 'unknown';
}
...
export class WorkflowTrajectory {
    ...
    shouldReflectOnConverge() {
        return this.enabled && this.reflectOnConverge;
    }
    shouldReflectOnBarriers() {
