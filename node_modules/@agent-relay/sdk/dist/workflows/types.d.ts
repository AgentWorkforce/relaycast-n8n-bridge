...
export type CompletionEvidenceSignalSource = 'channel' | 'stdout' | 'stderr' | 'process' | 'filesystem' | 'tool' | 'verification';
export type CompletionEvidenceSignalKind = 'worker_done' | 'lead_done' | 'step_complete' | 'owner_decision' | 'review_decision' | 'task_summary' | 'verification_passed' | 'verification_failed' | 'process_exit' | 'custom';
...
export type CompletionEvidenceToolSideEffectType = 'persist_step_output' | 'post_channel_message' | 'verification_observed' | 'worktree_created' | 'owner_monitoring' | 'review_started' | 'review_completed' | 'worker_exit' | 'worker_error' | 'retry' | 'custom';
...
export type StepCompletionMode = 'marker' | 'evidence' | 'verification' | 'owner_decision' | 'review' | 'heuristic';
...
export type WorkflowOwnerDecision = 'COMPLETE' | 'INCOMPLETE_RETRY' | 'INCOMPLETE_FAIL' | 'NEEDS_CLARIFICATION';
/**
 ...
 */
export type WorkflowStepCompletionReason = 'completed_verified' | 'completed_by_owner_decision' | 'completed_by_evidence' | 'completed_by_process_exit' | 'retry_requested_by_owner' | 'failed_verification' | 'failed_owner_decision' | 'failed_no_evidence';
